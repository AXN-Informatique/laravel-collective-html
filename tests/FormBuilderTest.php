...
class FormBuilderTest extends PHPUnit\Framework\TestCase
{
    ...
    public function test_request_value()
    {
    ...
    public function test_opening_form()
    {
    ...
    public function test_form_route()
    {
    ...
    public function test_closing_form()
    {
    ...
    public function test_macro_field()
    {
    ...
    public function test_passwords_not_filled()
    {
    ...
    public function test_files_not_filled()
    {
        $this->formBuilder->setSessionStore($session = m::mock('Illuminate\Contracts\Session\Session'));
    ...
    public function test_form_text()
    {
        $form1 = $this->formBuilder->input('text', 'foo');
    ...
    public function test_form_text_array()
    {
    ...
    public function test_form_text_repopulation()
    {
        $this->formBuilder->setSessionStore($session = m::mock('Illuminate\Contracts\Session\Session'));
    ...
    public function test_form_repopulation_with_mix_of_arrays_and_objects()
    {
    ...
    public function test_form_file()
    {
    ...
    public function test_select_collection()
    {
        $select = $this->formBuilder->select(
            'size',
    ...
    public function test_form_select_repopulation()
    {
    ...
    public function test_form_with_optional_placeholder()
    {
        $select = $this->formBuilder->select(
            'size',
            ['L' => 'Large', 'S' => 'Small'],
    ...
    public function test_form_select_year()
    {
    ...
    public function test_form_select_range()
    {
    ...
    public function test_form_select_month()
    {
    ...
    public function test_form_checkbox_repopulation()
    {
        $this->formBuilder->setSessionStore($session = m::mock('Illuminate\Contracts\Session\Session'));
    ...
    public function test_form_checkbox_with_model_relation()
    {
        $this->formBuilder->setSessionStore($session = m::mock('Illuminate\Contracts\Session\Session'));
        $session->shouldReceive('getOldInput')->withNoArgs()->andReturn([]);
    ...
    public function test_form_checkbox_without_session()
    {
    ...
    public function test_form_radio_with_attribute_cast_to_boolean()
    {
    ...
    public function test_form_radio_repopulation()
    {
        $this->formBuilder->setSessionStore($session = m::mock('Illuminate\Contracts\Session\Session'));
